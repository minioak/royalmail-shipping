...
/**
 * This class stands for CanonicalizationMethodType Structs
...
class CanonicalizationMethodType extends AbstractStructBase
{
     ...
     * Set Algorithm value
     * @param string $algorithm
     * @return \Minioak\Royalmail\Shipping\Structs\CanonicalizationMethodType
     */
     ...
     * @uses \DOMNode::item()
     * @uses \Minioak\Royalmail\Shipping\Structs\CanonicalizationMethodType::setAny()
