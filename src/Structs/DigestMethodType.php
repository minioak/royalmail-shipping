...
/**
 * This class stands for DigestMethodType Structs
...
class DigestMethodType extends AbstractStructBase
{
     ...
     * Set Algorithm value
     * @param string $algorithm
     * @return \Minioak\Royalmail\Shipping\Structs\DigestMethodType
     */
     ...
     * @uses \DOMNode::item()
     * @uses \Minioak\Royalmail\Shipping\Structs\DigestMethodType::setAny()
