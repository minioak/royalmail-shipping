...
/**
 * This class stands for completedCancelShipments Structs
 * Meta informations extracted from the WSDL
 * - documentation: schema to hold details of cancelled shipments and their associated status
 * @subpackage Structs
 */
class CompletedCancelShipments extends AbstractStructBase
{
    /**
     * The shipmentNumber
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for completedCancelShipments
     * @uses CompletedCancelShipments::setShipmentNumber()
     ...
     * @param string[] $shipmentNumber
     * @return \Minioak\Royalmail\Shipping\Structs\CompletedCancelShipments
     */
    public function setShipmentNumber(array $shipmentNumber = array())
    {
        ...
        foreach ($shipmentNumber as $completedCancelShipmentsShipmentNumberItem) {
            // validation for constraint: itemType
            if (!is_string($completedCancelShipmentsShipmentNumberItem)) {
                throw new \InvalidArgumentException(sprintf('The shipmentNumber property can only contain items of string, "%s" given', is_object($completedCancelShipmentsShipmentNumberItem) ? get_class($completedCancelShipmentsShipmentNumberItem) : gettype($completedCancelShipmentsShipmentNumberItem)), __LINE__);
            }
        }
