...
/**
 * This class stands for PasswordString Structs
...
class PasswordString extends AttributedString
{
     ...
     * @param string $type
     */
    public function __construct(\Minioak\Royalmail\Shipping\Structs\AttributedString $_ = null, $type = null)
    {
        $this
            ->set_($_)
            ->setType($type);
     ...
     * Set _ value
     * @param \Minioak\Royalmail\Shipping\Structs\AttributedString $_
     * @return \Minioak\Royalmail\Shipping\Structs\PasswordString
     */
