...
/**
 * This class stands for SignatureMethodType Structs
...
class SignatureMethodType extends AbstractStructBase
{
     ...
     * Set Algorithm value
     * @param string $algorithm
     * @return \Minioak\Royalmail\Shipping\Structs\SignatureMethodType
     */
     ...
     * @uses \DOMNode::item()
     * @uses \Minioak\Royalmail\Shipping\Structs\SignatureMethodType::setAny()
